...
\begin{equation}
P(\theta | X_1, X_2,\ldots, X_\mathrm{N})P(X_1, X_2,\ldots, X_\mathrm{N}) = P(\theta, X_1, X_2,\ldots, X_\mathrm{N})
\end{equation}
and divide by the second term on the left-hand side.
\begin{equation} \label{eq:pre_fact}
P(\theta | X_1, X_2,\ldots, X_\mathrm{N}) = \frac{P(\theta, X_1, X_2,\ldots, X_\mathrm{N})}{P(X_1, X_2,\ldots, X_\mathrm{N})}
\end{equation}
...
P(\theta | X_1, X_2,\ldots, X_\mathrm{N}) = \frac{P(\theta)\prod_{i=1}^{N}P(X_\mathrm{i}|\theta)}{P(X_1, X_2,\ldots, X_\mathrm{N})}
\end{equation}
